...
export default function VideoCard(props){
    ...
    return(
            <Card sx={{ maxWidth: 345 , minHeight:260,backgroundColor:"#414040"}} onClick={()=>handelVideoPageNav(props.video._id)}>
                <CardActionArea>
                    <CardMedia
                        component="img"
                        height="140"
                    ...
                    <CardContent sx={{backgroundColor:"#whitesmoke" ,color:'grey'}}>
                        <Typography variant='h6' component="div" color="white">{props.video.title}</Typography>
                        <Typography variant='body2' color="whitesmoke">{ dateString}</Typography>
                    </CardContent>
                </CardActionArea>
            </Card>
    );
